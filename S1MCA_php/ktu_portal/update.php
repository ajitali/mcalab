...
<?php
$sel="select Distinct Ktuid From markupload";
...
if(isset($_POST['sub']))
{
    $ktuid=$_POST['ktu'];
    $sub=$_POST['Sub'];
    $select="Select*From markupload Where Ktuid='$ktuid' And subcode='$sub'";
...
if(isset($_POST['update']))
{
    ...
    $update="update markupload set Series1=$sr1,Series2=$sr2,Assignment1=$assg1,Assignment2=$assg2,Attendance=$atnd where Ktuid='$ktuid' and subject='$sub'";
